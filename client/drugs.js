var info = {
  methadone : {
    ...
    successStories: [
      {name: "Sharon", image: "women/10.jpg", text: "After beginning daily methadone medication, she never used opiates again. After several attempts, she also achieved abstinence from Xanax, and remained completely drug free from that point forward..."},
      {name: "Kiley", image: "women/42.jpg", text: "After two months receiving methadone, Kiley became completely free of illicit drugs. Everything about her changed dramatically. She gained weight. Her depression lifted, and her mental clarity..."},
      {name: "Franklin", image: "men/30.jpg", text: "When Franklin began methadone maintenance, he experienced the kind of relief he had been hoping for. Withdrawal sickness ended. Like many people, his energy returned. He began to get a grip on his life, and..."},
      {name: "Steven", image: "men/8.jpg", text: "He had heard about methadone and decided he should give it a chance since everything else he had tried did not work. The decision paid off. Methadone provided excellent relief, and enabled Steven to..."},
      {name: "Barry", image: "men/50.jpg", text: "Fast forward 6 years, Barry worked successfully through all phases in his methadone treatment clinic. Along the way, he maintained steady employment, joined a church, resumed parenting of his child..."}
    ]
  },
  buprenorphine : {
    name: "buprenorphine",
    ...
    successStories: [
      {name: "Russell", image: "men/13.jpg", text: "Not only has Suboxone given me another chance at life, it has given my kids their daddy back!.."},
      {name: "Victoria", image: "women/29.jpg", text: "My only regret with Suboxone is that I didn't try it sooner. My advice to anyone that is struggling with an addiction is to give it a try. I also believe that therapy is a very important part of recovery..."},
      {name: "Gloria", image: "women/8.jpg", text: "...It helped me a lot, but without the Suboxone I don't think I would have made it..."},
      {name: "Keith", image: "men/33.jpg", text: "I would say if you are addicted to opiates to please give Suboxone a try – if you have tried every other way and failed first. Bupe isn't for everyone but it works wonders for me..."},
      {name: "Ian", image: "men/27.jpg", text: "I am approaching 3 months on Suboxone, and I have my life back..."},
    ]
  },
  naltrexone : {
    name: "naltrexone",
    ...
    successStories: [
      {name: "Adam", image: "men/44.jpg", text: "Naltrexone is not some sort of miracle cure. It is one thing that can help a person along their path to recovery. In my case, it helped give me some headspace (free of cravings) where I could focus on trying to learn to live without drugs and alcohol. The drug didn’t make me better. I made myself better, with the help of key people around me..."},
    ]
  }
};

var loadGoodRXWidget = function(drug){
  // $("#goodrx_low-price_widget").empty()
  _grxdn = drug;
  (function(d, t) {
